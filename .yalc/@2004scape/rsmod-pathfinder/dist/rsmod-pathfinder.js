async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    findPath(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, angle, shape, moveNear, blockAccessFlags, maxWaypoints, collision) {
      // src/index/findPath(i32, i32, i32, i32, i32, i32?, i32?, i32?, i32?, i32?, bool?, i32?, i32?, i32?) => ~lib/staticarray/StaticArray<i32>
    ...
    findNaivePath(level, srcX, srcZ, destX, destZ, srcWidth, srcHeight, destWidth, destHeight, blockAccessFlags, collision) {
      // src/index/findNaivePath(i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32?) => ~lib/staticarray/StaticArray<i32>
      exports.__setArgumentsLength(arguments.length);
    ...
    changeFloor(x, z, level, add) {
      // src/index/changeFloor(i32, i32, i32, bool) => void
      add = add ? 1 : 0;
      exports.changeFloor(x, z, level, add);
    },
    changeLoc(x, z, level, width, length, blockrange, breakroutefinding, add) {
      // src/index/changeLoc(i32, i32, i32, i32, i32, bool, bool, bool) => void
    ...
    allocateIfAbsent(absoluteX, absoluteZ, level) {
      // src/index/allocateIfAbsent(i32, i32, i32) => ~lib/staticarray/StaticArray<i32>
    ...
    hasLineOfSight(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, extraFlag) {
      // src/index/hasLineOfSight(i32, i32, i32, i32, i32, i32?, i32?, i32?, i32?) => bool
      exports.__setArgumentsLength(arguments.length);
    ...
    hasLineOfWalk(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, extraFlag) {
      // src/index/hasLineOfWalk(i32, i32, i32, i32, i32, i32?, i32?, i32?, i32?) => bool
      exports.__setArgumentsLength(arguments.length);
    ...
    lineOfSight(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, extraFlag) {
      // src/index/lineOfSight(i32, i32, i32, i32, i32, i32?, i32?, i32?, i32?) => ~lib/staticarray/StaticArray<i32>
      exports.__setArgumentsLength(arguments.length);
    ...
    lineOfWalk(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, extraFlag) {
      // src/index/lineOfWalk(i32, i32, i32, i32, i32, i32?, i32?, i32?, i32?) => ~lib/staticarray/StaticArray<i32>
      exports.__setArgumentsLength(arguments.length);
    ...
    reached(level, srcX, srcZ, destX, destZ, destWidth, destHeight, srcSize, angle, shape, blockAccessFlags) {
      // src/index/reached(i32, i32, i32, i32, i32, i32, i32, i32, i32?, i32?, i32?) => bool
      exports.__setArgumentsLength(arguments.length);
    ...
    __collides(srcX, srcZ, destX, destZ, srcWidth, srcHeight, destWidth, destHeight) {
      // src/index/__collides(i32, i32, i32, i32, i32, i32, i32, i32) => bool
    ...
    __reachRectangle1(level, srcX, srcZ, destX, destZ, destWidth, destHeight, blockAccessFlags) {
      // src/index/__reachRectangle1(i32, i32, i32, i32, i32, i32, i32, i32) => bool
    ...
    __reachRectangleN(level, srcX, srcZ, destX, destZ, srcWidth, srcHeight, destWidth, destHeight, blockAccessFlags) {
      // src/index/__reachRectangleN(i32, i32, i32, i32, i32, i32, i32, i32, i32, i32) => bool
    ...
    __reachRectangle(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, angle, blockAccessFlags) {
      // src/index/__reachRectangle(i32, i32, i32, i32, i32, i32, i32, i32, i32, i32) => bool
    ...
    __reachExclusiveRectangle(level, srcX, srcZ, destX, destZ, srcSize, destWidth, destHeight, angle, blockAccessFlags) {
      // src/index/__reachExclusiveRectangle(i32, i32, i32, i32, i32, i32, i32, i32, i32, i32) => bool
