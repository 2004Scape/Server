...
class BankerTalk extends BaseScript {
    *run(player) {
        ...
        yield this.chatnpc('default', `Good day, how may I help you?`);
        ...
        if (this.choice == 1) {
            ...
            yield this.chatplayer('default', `What is this place?`);
            yield this.chatnpc('default', `This is a branch of the Bank of Gielinor. We have`, `branches in many towns.`);
            yield this.chatplayer('default', `And what do you do?`);
            yield this.chatnpc('default', `We will look after your items and money for you.`, `Leave your valuables with us if you want to keep them`, `safe.`);
        }
    }
}
