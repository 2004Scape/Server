...
export default {
    ...
    // WEB_CSRF_PROTECT tightens security somewhat by embedding a token in the
    ...
    // NOTE: if you set csrf protection on, and there were clients with page loaded without this option on,
    // they wont be able to connect until they F5, as the cookie won't have been sent.
    WEB_CSRF_PROTECT: tryParseBoolean(process.env.WEB_CSRF_PROTECT, false),
