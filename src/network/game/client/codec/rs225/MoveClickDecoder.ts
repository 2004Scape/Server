...
export default class MoveClickDecoder extends MessageDecoder<MoveClick> {
    constructor(readonly prot: ClientProt225) {
        super();
    }
    ...
    decode(buf: Packet, length: number) {
        ...
        const offset: number = this.prot === ClientProt225.MOVE_MINIMAPCLICK ? 14 : 0;
        ...
        return new MoveClick(path, ctrlHeld, this.prot === ClientProt225.MOVE_OPCLICK);
    }
}
