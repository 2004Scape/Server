...
import ChatSetModeDecoder from '#/network/rs244/client/codec/game/ChatSetModeDecoder.js';
import ClientCheatDecoder from '#/network/rs244/client/codec/game/ClientCheatDecoder.js';
import CloseModalDecoder from '#/network/rs244/client/codec/game/CloseModalDecoder.js';
import EventTrackingDecoder from '#/network/rs244/client/codec/game/EventTrackingDecoder.js';
import FriendListAddDecoder from '#/network/rs244/client/codec/game/FriendListAddDecoder.js';
import FriendListDelDecoder from '#/network/rs244/client/codec/game/FriendListDelDecoder.js';
import IdleTimerDecoder from '#/network/rs244/client/codec/game/IdleTimerDecoder.js';
import IfButtonDecoder from '#/network/rs244/client/codec/game/IfButtonDecoder.js';
import IfPlayerDesignDecoder from '#/network/rs244/client/codec/game/IfPlayerDesignDecoder.js';
import IgnoreListAddDecoder from '#/network/rs244/client/codec/game/IgnoreListAddDecoder.js';
import IgnoreListDelDecoder from '#/network/rs244/client/codec/game/IgnoreListDelDecoder.js';
import InvButtonDDecoder from '#/network/rs244/client/codec/game/InvButtonDDecoder.js';
import InvButtonDecoder from '#/network/rs244/client/codec/game/InvButtonDecoder.js';
import MessagePrivateDecoder from '#/network/rs244/client/codec/game/MessagePrivateDecoder.js';
import MessagePublicDecoder from '#/network/rs244/client/codec/game/MessagePublicDecoder.js';
import MoveClickDecoder from '#/network/rs244/client/codec/game/MoveClickDecoder.js';
import OpHeldDecoder from '#/network/rs244/client/codec/game/OpHeldDecoder.js';
import OpHeldTDecoder from '#/network/rs244/client/codec/game/OpHeldTDecoder.js';
import OpHeldUDecoder from '#/network/rs244/client/codec/game/OpHeldUDecoder.js';
import OpLocDecoder from '#/network/rs244/client/codec/game/OpLocDecoder.js';
import OpLocTDecoder from '#/network/rs244/client/codec/game/OpLocTDecoder.js';
import OpLocUDecoder from '#/network/rs244/client/codec/game/OpLocUDecoder.js';
import OpNpcDecoder from '#/network/rs244/client/codec/game/OpNpcDecoder.js';
import OpNpcTDecoder from '#/network/rs244/client/codec/game/OpNpcTDecoder.js';
import OpNpcUDecoder from '#/network/rs244/client/codec/game/OpNpcUDecoder.js';
import OpObjDecoder from '#/network/rs244/client/codec/game/OpObjDecoder.js';
import OpObjTDecoder from '#/network/rs244/client/codec/game/OpObjTDecoder.js';
import OpObjUDecoder from '#/network/rs244/client/codec/game/OpObjUDecoder.js';
import OpPlayerDecoder from '#/network/rs244/client/codec/game/OpPlayerDecoder.js';
import OpPlayerTDecoder from '#/network/rs244/client/codec/game/OpPlayerTDecoder.js';
import OpPlayerUDecoder from '#/network/rs244/client/codec/game/OpPlayerUDecoder.js';
import ReportAbuseDecoder from '#/network/rs244/client/codec/game/ReportAbuseDecoder.js';
import ResumePauseButtonDecoder from '#/network/rs244/client/codec/game/ResumePauseButtonDecoder.js';
import ResumePCountDialogDecoder from '#/network/rs244/client/codec/game/ResumePCountDialogDecoder.js';
import TutorialClickSideDecoder from '#/network/rs244/client/codec/game/TutorialClickSideDecoder.js';
