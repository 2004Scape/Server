import CamLookAtEncoder from '#/network/rs244/server/codec/game/CamLookAtEncoder.js';
import CamMoveToEncoder from '#/network/rs244/server/codec/game/CamMoveToEncoder.js';
import CamResetEncoder from '#/network/rs244/server/codec/game/CamResetEncoder.js';
import CamShakeEncoder from '#/network/rs244/server/codec/game/CamShakeEncoder.js';
import ChatFilterSettingsEncoder from '#/network/rs244/server/codec/game/ChatFilterSettingsEncoder.js';
import EnableTrackingEncoder from '#/network/rs244/server/codec/game/EnableTrackingEncoder.js';
import FinishTrackingEncoder from '#/network/rs244/server/codec/game/FinishTrackingEncoder.js';
import HintArrowEncoder from '#/network/rs244/server/codec/game/HintArrowEncoder.js';
import IfCloseEncoder from '#/network/rs244/server/codec/game/IfCloseEncoder.js';
import IfOpenChatEncoder from '#/network/rs244/server/codec/game/IfOpenChatEncoder.js';
import IfOpenMainEncoder from '#/network/rs244/server/codec/game/IfOpenMainEncoder.js';
import IfOpenMainSideEncoder from '#/network/rs244/server/codec/game/IfOpenMainSideEncoder.js';
import IfOpenSideEncoder from '#/network/rs244/server/codec/game/IfOpenSideEncoder.js';
import IfSetAnimEncoder from '#/network/rs244/server/codec/game/IfSetAnimEncoder.js';
import IfSetColourEncoder from '#/network/rs244/server/codec/game/IfSetColourEncoder.js';
import IfSetHideEncoder from '#/network/rs244/server/codec/game/IfSetHideEncoder.js';
import IfSetModelEncoder from '#/network/rs244/server/codec/game/IfSetModelEncoder.js';
import IfSetNpcHeadEncoder from '#/network/rs244/server/codec/game/IfSetNpcHeadEncoder.js';
import IfSetObjectEncoder from '#/network/rs244/server/codec/game/IfSetObjectEncoder.js';
import IfSetPlayerHeadEncoder from '#/network/rs244/server/codec/game/IfSetPlayerHeadEncoder.js';
import IfSetPositionEncoder from '#/network/rs244/server/codec/game/IfSetPositionEncoder.js';
import IfSetRecolEncoder from '#/network/rs244/server/codec/game/IfSetRecolEncoder.js';
import IfSetTabActiveEncoder from '#/network/rs244/server/codec/game/IfSetTabActiveEncoder.js';
import IfSetTabEncoder from '#/network/rs244/server/codec/game/IfSetTabEncoder.js';
import IfSetTextEncoder from '#/network/rs244/server/codec/game/IfSetTextEncoder.js';
import LastLoginInfoEncoder from '#/network/rs244/server/codec/game/LastLoginInfoEncoder.js';
import LocAddChangeEncoder from '#/network/rs244/server/codec/game/LocAddChangeEncoder.js';
import LocAnimEncoder from '#/network/rs244/server/codec/game/LocAnimEncoder.js';
import LocDelEncoder from '#/network/rs244/server/codec/game/LocDelEncoder.js';
import LocMergeEncoder from '#/network/rs244/server/codec/game/LocMergeEncoder.js';
import LogoutEncoder from '#/network/rs244/server/codec/game/LogoutEncoder.js';
import MapAnimEncoder from '#/network/rs244/server/codec/game/MapAnimEncoder.js';
import MapProjAnimEncoder from '#/network/rs244/server/codec/game/MapProjAnimEncoder.js';
import MessageGameEncoder from '#/network/rs244/server/codec/game/MessageGameEncoder.js';
import MessagePrivateEncoder from '#/network/rs244/server/codec/game/MessagePrivateEncoder.js';
import MidiJingleEncoder from '#/network/rs244/server/codec/game/MidiJingleEncoder.js';
import MidiSongEncoder from '#/network/rs244/server/codec/game/MidiSongEncoder.js';
import NpcInfoEncoder from '#/network/rs244/server/codec/game/NpcInfoEncoder.js';
import ObjAddEncoder from '#/network/rs244/server/codec/game/ObjAddEncoder.js';
import ObjCountEncoder from '#/network/rs244/server/codec/game/ObjCountEncoder.js';
import ObjDelEncoder from '#/network/rs244/server/codec/game/ObjDelEncoder.js';
import ObjRevealEncoder from '#/network/rs244/server/codec/game/ObjRevealEncoder.js';
import PCountDialogEncoder from '#/network/rs244/server/codec/game/PCountDialogEncoder.js';
import PlayerInfoEncoder from '#/network/rs244/server/codec/game/PlayerInfoEncoder.js';
import RebuildNormalEncoder from '#/network/rs244/server/codec/game/RebuildNormalEncoder.js';
import ResetAnimsEncoder from '#/network/rs244/server/codec/game/ResetAnimsEncoder.js';
import ResetClientVarCacheEncoder from '#/network/rs244/server/codec/game/ResetClientVarCacheEncoder.js';
import SetMultiwayEncoder from '#/network/rs244/server/codec/game/SetMultiwayEncoder.js';
import SynthSoundEncoder from '#/network/rs244/server/codec/game/SynthSoundEncoder.js';
import TutFlashEncoder from '#/network/rs244/server/codec/game/TutFlashEncoder.js';
import TutOpenEncoder from '#/network/rs244/server/codec/game/TutOpenEncoder.js';
import UnsetMapFlagEncoder from '#/network/rs244/server/codec/game/UnsetMapFlagEncoder.js';
import UpdateFriendListEncoder from '#/network/rs244/server/codec/game/UpdateFriendListEncoder.js';
import UpdateIgnoreListEncoder from '#/network/rs244/server/codec/game/UpdateIgnoreListEncoder.js';
import UpdateInvFullEncoder from '#/network/rs244/server/codec/game/UpdateInvFullEncoder.js';
import UpdateInvPartialEncoder from '#/network/rs244/server/codec/game/UpdateInvPartialEncoder.js';
import UpdateInvStopTransmitEncoder from '#/network/rs244/server/codec/game/UpdateInvStopTransmitEncoder.js';
import UpdatePidEncoder from '#/network/rs244/server/codec/game/UpdatePidEncoder.js';
import UpdateRebootTimerEncoder from '#/network/rs244/server/codec/game/UpdateRebootTimerEncoder.js';
import UpdateRunEnergyEncoder from '#/network/rs244/server/codec/game/UpdateRunEnergyEncoder.js';
import UpdateRunWeightEncoder from '#/network/rs244/server/codec/game/UpdateRunWeightEncoder.js';
import UpdateStatEncoder from '#/network/rs244/server/codec/game/UpdateStatEncoder.js';
import UpdateZoneFullFollowsEncoder from '#/network/rs244/server/codec/game/UpdateZoneFullFollowsEncoder.js';
import UpdateZonePartialEnclosedEncoder from '#/network/rs244/server/codec/game/UpdateZonePartialEnclosedEncoder.js';
import UpdateZonePartialFollowsEncoder from '#/network/rs244/server/codec/game/UpdateZonePartialFollowsEncoder.js';
import VarpLargeEncoder from '#/network/rs244/server/codec/game/VarpLargeEncoder.js';
import VarpSmallEncoder from '#/network/rs244/server/codec/game/VarpSmallEncoder.js';
